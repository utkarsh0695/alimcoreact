...
const SidebarMenu = ({ menu,setMainMenu, props, sidebartoogle, setNavActive, activeClass, width }) => {
    ...
    <nav className="sidebar-main" id="sidebar-main">
      ...
      >
        <ul className="sidebar-links custom-scrollbar">
          ...
          <SidebarMenuItems menu={menu} setMainMenu={setMainMenu} props={props} sidebartoogle={sidebartoogle} setNavActive={setNavActive} activeClass={activeClass} />
        </ul>
      </div>
